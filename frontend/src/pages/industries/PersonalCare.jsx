      ...
      <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-3xl">
            We synthesize and scale advanced active ingredients for cosmetics and skincare—peptides, botanical extracts, and novel functional molecules. Our expertise translates lab discoveries into stable, efficacious, and regulatory-compliant actives ready for formulation.
          </p>
        </div>
      </section>
